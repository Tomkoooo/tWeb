...
import { krauszClassicTheme } from "./theme"
...
export const krauszClassic: TemplateModule = defineTemplate({
  manifest: {
    id: "krausz-classic",
    name: "Krausz Classic",
    version: "1.0.0",
    ...
    description:
      "Industrial black/orange storefront ported from the original Krausz Barkácsmester webshop — hero, brand story, features, catalog, and contact on the visual block-based homepage editor.",
    screenshots: ["/template-previews/krausz-classic.svg"],
    capabilities: {
      hasBlog: false,
  ...
  defaultTheme: krauszClassicTheme,
  chrome: {
    Navbar,
    Footer,
  },
