"use client"
/* eslint-disable @typescript-eslint/no-explicit-any -- legacy checkout UI (extracted from page.tsx) */
              ...
              <div key={step.id} className="relative z-10 flex flex-col items-center gap-4">
                <div 
                  className={cn(
                    ...
                    isActive ? "bg-primary border-primary text-primary-foreground scale-110 shadow-[0_0_20px_color-mix(in_oklab,var(--primary)_30%,transparent)]" :
                    isCompleted ? "bg-muted text-foreground border-border" : "bg-background border-border text-muted-foreground"
                  )}
                >
          ...
          <div className="lg:col-span-4">
            <div className="glass-card p-8 border-border sticky top-40">
              <div className="flex items-center gap-3 mb-8 border-b border-border pb-4">
                ...
                <h3 className="font-heading font-black text-foreground uppercase tracking-tighter">MEGRENDELÉS</h3>
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-border">
                ...
                <div className="flex justify-between items-end pt-4">
                  <div className="flex flex-col">
                    <p className="text-[10px] font-black text-foreground uppercase tracking-[0.3em] mb-1">Összesen</p>
