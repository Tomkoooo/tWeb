...
- [CREATING_A_TEMPLATE.md](../templates/CREATING_A_TEMPLATE.md) — template module contract; non-home surfaces have no admin CMS in this engine.
- [AI_AGENTS_TEMPLATE_GUIDE.md](../templates/AI_AGENTS_TEMPLATE_GUIDE.md) — agent-oriented checklist.
